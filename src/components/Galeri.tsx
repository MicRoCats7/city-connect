...
function Galeri() {
    ...
    return (
        <section className="max-w-[1440px] mx-auto px-4 tablet:px-12 desktop:px-36 py-[100px]" id={t('navbar.gallery')}>
            <div className="flex items-center justify-end gap-4">
                <Separator className="border-2 rounded-full w-[94px]" />
                <h2 className="desktop:text-[50px] text-3xl font-general-sans-semibold special-text pb-2">{t("gallery.title")}</h2>
            </div>
                        ...
                        if (index !== 2) {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="w-full absolute bottom-4 p-5 bg-gradient-to-t from-black/100 to-transparent bg-transparent rounded-[20px]">
                                        <p className="mb-5 desktop:text-[50px] text-4xl font-general-sans-semibold text-white bg-transparent">{galeri.name}</p>
                                    </div>
                                </div>
                            )
                        }
