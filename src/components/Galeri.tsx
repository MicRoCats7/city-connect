...
function Galeri() {
  ...
  return (
    <section
      className="max-w-[1440px] mx-auto px-4 tablet:px-12 desktop:px-36 py-[100px]"
      id={t("navbar.gallery")}
    >
      <div className="flex items-center justify-end gap-4">
        <Separator className="border-2 rounded-full w-[94px]" />
        <h2 className="desktop:text-[50px] text-3xl font-general-sans-semibold special-text pb-2">
          {t("gallery.title")}
        </h2>
      </div>
      <div className="desktop:mt-10 mt-5">
        <div className="grid desktop:grid-cols-4 tablet:grid-cols-4 mobile:grid-cols-3 desktop:grid-rows-2 gap-2.5">
            ...
            if (index !== 2) {
              return (
                <div
                  ...
                  className="relative col-span-1 flex flex-col justify-between cursor-pointer bg-transparent transition duration-300 transform hover:scale-90"
                >
                  <img
                    className="mb-[17px] h-[180px] rounded-[20px]"
                  ...
                  <div className="w-full absolute bottom-4 p-5 bg-gradient-to-t from-black/100 to-transparent bg-transparent rounded-[20px]">
                    <p className="mb-0 text-[22px] font-general-sans-semibold text-white bg-transparent">
                      {galeri.name}
                    </p>
                  </div>
                </div>
              ...
              return (
                ...
                >
                  <img
                    ...
                    alt={galeri.name}
                  />
                  <div className="absolute left-[46%] desktop:top-[40%] top-[30%] bg-transparent">
                    <FaPlay
                      className="bg-transparent"
                      size={50}
                      color="white"
                  ...
                  <div className="w-full absolute bottom-4 p-5 bg-gradient-to-t from-black/100 to-transparent bg-transparent rounded-[20px]">
                    <p className="mb-5 desktop:text-[50px] text-4xl font-general-sans-semibold text-white bg-transparent">
                      {galeri.name}
                    </p>
                  </div>
                </div>
        ...
        <div className="grid desktop:grid-cols-4 tablet:grid-cols-4 desktop:grid-rows-2 gap-2.5">
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-65">
          <div ref={modalRef} className="relative w-full max-w-4xl">
            <button
              onClick={closeModal}
              className="absolute -top-2 desktop:-right-2 right-0 text-xl font-bold bg-white rounded-full p-2"
            >
