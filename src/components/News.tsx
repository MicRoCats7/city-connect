                ...
                <div className="mt-16">
                    <div className="grid grid-cols-4 grid-rows-2 gap-2.5">
                        {berita.map((news, index) => {
                            if (index !== 2) {
                                return (
                                    <div key={news.id} className="relative col-span-1 flex flex-col justify-between cursor-pointer bg-transparent">
                                        <img
                                ...
                                return (
                                    <div key={news.id} className="relative col-span-2 row-span-2 flex flex-col justify-between cursor-pointer hover:scale-105 transition transform">
                                        <img
