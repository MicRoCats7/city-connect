...
function PetaGaleri() {
    ...
    return (
        <section className="max-w-[1440px] mx-auto px-4 tablet:px-12 desktop:px-36 py-44 flex items-center justify-center flex-col" id={t('navbar.maps_smart_city')}>
            ...
            <MapContainer center={[-2.5, 118.0]} zoom={5} className="w-full h-[550px] mt-8 z-10">
                <TileLayer
                        ...
                        >
                            <div className='flex items-start flex-col gap-1'>
                                ...
                                <div className='flex items-center gap-2'>
                                    <h6 className="font-general-sans-regular">{t("maps_smart_city.feature")}{city.name}</h6>
                                    <Popover>
                                        <PopoverTrigger>
                                        ...
                                        <PopoverContent
                                            ...
                                            tabIndex={-1}
                                        >
                                            <p className="text-sm text-center">{t("maps_smart_city.click")}</p>
                                        </PopoverContent>
                                    </Popover>
                                </div>
                            </div>
                                                ...
                                                <CardContent className="relative items-center justify-center p-1 w-[400px]">
                                                    <Popover>
                                                        ...
                                                        <PopoverContent className="bg-black text-white p-4 rounded-md">
                                                            <h1 className='font-general-sans-semibold text-left'>{photo.title}</h1>
                                                            <Separator className='mb-2 border-[2px]' />
                                                            <p className="text-sm text-left font-general-sans-regular">{photo.desc}</p>
                                                        </PopoverContent>
                                                    </Popover>
                                                </CardContent>
                                            </Card>
