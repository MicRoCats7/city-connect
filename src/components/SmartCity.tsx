...
function SmartCity() {
    ...
    const Hexagon = ({ color, label, icon }: { color: any, label: string, icon: any }) => (
        <div className={`scale-95 tablet:scale-80 desktop:scale-100 relative w-[290px] h-[340px] clip-hexagon flex items-center justify-center text-white hover:scale-90 transition transform cursor-pointer`} style={{ backgroundColor: color }}>
            <div className="flex items-center justify-center flex-col gap-2 bg-transparent">
                ...
                <div className="flex items-center gap-2 bg-transparent">
                    <p className="text-sm font-general-sans-regular bg-transparent">{t("smart_city.button_click")}</p>
    ...
    return (
        <section className="flex justify-center items-center flex-col pt-32 relative max-w-[1440px] mx-auto px-4 tablet:px-12 desktop:px-36" id={t('navbar.smart_city')}>
            ...
            <div className="flex items-center justify-center flex-col">
                <h1 className="special-text text-[30px] desktop:text-[50px] font-general-sans-semibold">{t("smart_city.title")}</h1>
                <p className="text-[#ffffff60] text-sm desktop:text-lg font-general-sans-regular">{t("smart_city.subtitle")}</p>
            </div>
